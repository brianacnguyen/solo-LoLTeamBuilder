...
.controller('ChampsController', function($scope) {
    $scope.data = {};
    $scope.live = {};
    $scope.live.top = "assets/images/Top_Placeholder.jpg";
    $scope.live.jungle = "assets/images/Jungle_Placeholder.jpg";
    $scope.live.mid = "assets/images/Mid_Placeholder.jpg";
    $scope.live.bot = "assets/images/Bot_Placeholder.jpg";
    $scope.live.support = "assets/images/Support_Placeholder.jpg";
